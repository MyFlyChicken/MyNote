 ...
 * @par 修改日志:
 * <table>
 * <caption id="multi_row">这是我的表</caption>
 ...
 * @details
 */
void print1(void) { printf("this is printf1\r\n"); }
 ...
 * @details
 */
void print2(void) { printf("this is printf2\r\n"); }
 ...
 * @details
 */
void print_arg(char *str) { printf("%s\r\n", str); }
/**
 *@}
 */
